...
const Homepage = () => {
  ...
  return (
      ...
      <h1>Skriv inn fødselsnummer</h1>
        ...
        <input className={"p-3 bg-custom-light-grey text-center text-black placeholder-custom-dark-grey m-1 rounded-full w-full font-semibold dark:bg-custom-very-darker-grey dark:text-white"}
