export const themes = {
  theme1: {
    ...
    container: "bg-teal-500 h-96 w-96 flex flex-col items-center justify-center rounded-sm",
    button: "p-3 my-1 bg-emerald-600 rounded-full text-white w-full font-semibold",
